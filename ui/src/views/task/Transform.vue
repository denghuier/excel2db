 ...
 <div class="line">
              ...
              <div id="container" style="display: flex; justify-content: space-between; position: relative;">
                ...
                >
                  ...
                  <el-table-column prop="colName" label="列名称" min-width="70px"/>
                ...
                >
                  ...
                  <el-table-column prop="columnName" label="名称" min-width="100px"/>
                  <el-table-column prop="columnType" label="类型" min-width="90px"/>
